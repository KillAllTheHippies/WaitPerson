...
public class DinersListAdapter extends ArrayAdapter<Diner> {
    public DinersListAdapter(Context context, ArrayList<Diner> diners) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       tvDiner.setText("Diner: " + diner.getDinerNum() + " Order: " + diner.getOrder());
